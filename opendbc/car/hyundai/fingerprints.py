              ...
              b'fwVersion',
                    b'existingFirmware',
                         ...
                         {'address': 1971,
                          ...
                          'bus': 1,
                          'ecu': 'hvac',
                          'fwVersion': b"\xf1\x00IK PE 97255-G9NB0CONTROL ASS'Y-DATC  1.03IKPE DATC(-) 0.7     ",
                          'logging': True,
                         ...
                         {'address': 1988,
                          ...
                          'bus': 1,
                          'ecu': 'fwdCamera',
                          'fwVersion': b'\xf1\x00IK  MFC  AT USA LHD 1.00 1.04 99211-G9000 220401',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'"\xf1\x00'],
                         ...
                         {'address': 2000,
                          ...
                          'bus': 0,
                          'ecu': 'fwdRadar',
                          'fwVersion': b'\xf1\x10\x17\xdf\x01\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'"\xf1\x10'],
                          'responseAddress': 2008,
                         ...
                         {'address': 2016,
                          ...
                          'bus': 1,
                          'ecu': 'engine',
                          'fwVersion': b'IPPNHM_Y_T0B\x00\x00\x00\x00',
                          'logging': True,
                          'obdMultiplexing': True,
                          'request': [b'>\x00', b'"\xf1\x82'],
                         ...
                         {'address': 2016,
                          ...
                          'bus': 1,
                          'ecu': 'engine',
                          'fwVersion': b'\xf1\x82IPPNHM_Y_T0B\x00\x00\x00\x00',
                          'logging': False,
                          'obdMultiplexing': True,
                         ...
                         {'address': 2017,
                          ...
                          'bus': 1,
                          'ecu': 'transmission',
                          'fwVersion': b'\xf1\x87WBPTH13315662CN7feVVwvWw\x86fffxuWy\x88wgw\x97vvfUD?\xffD[\xf1\x89E31\x00\x00\x00\x00\x00\x00\x00'
                                       b'\xf1\x82SIK4T20NH0',
                          'logging': False,
                          'obdMultiplexing': True,
                          'request': [b'"\xf1\x87\xf1\x89\xf1\x82'],
